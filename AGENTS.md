...
- **Keep agent plans local**: Store design specifications and implementation plans under `docs/superpowers/`. Keep that directory ignored; never force-add or commit files from it.
